...
data { 
  ...
  array[N_seasonality] int<lower=1> s; // seasonality 
  ...
  array[N] int<lower=1,upper=N_series>       series;
...
parameters {
  ...
  array[N_periods-1] row_vector[N_series]              nu_trend; // Random changes in trend
  ...
  // SEASONALITY
  array[N_seasonality] matrix[N_periods-1+max_s, N_series]                w_t; // Random variation in seasonality
  array[N_seasonality] vector<lower=0>[N_series]                           theta_season; // Variance in seasonality
  ...
  array[N_periods - 1] row_vector[N_series]                                kappa;  // Random changes in cyclicality
  array[N_periods - 1] row_vector[N_series]                                kappa_star; // Random changes in counter-cycle
...
transformed parameters {
  ...
  array[N_seasonality] matrix[N_periods-1, N_series]  tau_s; // Seasonality for each periodicity
...
generated quantities {
  ...
  array[N_seasonality] matrix[periods_to_predict, N_series]             w_t_hat;
